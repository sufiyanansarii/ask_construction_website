...
import Footer from '../../Components/Cardcomponent/Footer/Footer';
...
const Pagespage = () => {
  ...
  return (
    <div className='pagespage'>
      ...
      {/* <ThemeToggle /> */}
      <Navigation />
      <div className='pages-page-main'>
        <div className='pages-page-main-content'>
          <div className='container'>
            <div className='pages-page-heading'>
              <h2 className='pp-heading' data-aos="fade-down-right">our services</h2>
            </div>
          </div>
        </div>
        ...
        <div className='container'>
          <div className='container'>
            ...
            <div className='footer_contact'>
              <div className='partner_img' data-aos="fade-right" ><img src={p1} alt="" /></div>
              <div className='partner_img' data-aos="fade-up-right"><img src={p2} alt="" /></div>
              <div className='partner_img' data-aos="fade-up-left"><img src={p3} alt="" /></div>
              <div className='partner_img' data-aos="fade-down-right"><img src={p4} alt="" /></div>
              <div className='partner_img' data-aos="fade-left"><img src={p5} alt="" /></div>
