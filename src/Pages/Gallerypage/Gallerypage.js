...
import projects1 from '../../assets/images/touse/orchidn.jpeg'
import projects2 from '../../assets/images/touse/17-0000.jpg'
import projects3 from '../../assets/images/touse/15-0000.jpg'
import projects4 from '../../assets/images/touse/sssssppp.jpeg'
...
import projects7 from '../../assets/images/touse/cccntrain.jpeg'
import projects8 from '../../assets/images/touse/children.jpeg'
import projects9 from '../../assets/images/touse/cl.jpeg'
import projects10 from '../../assets/images/touse/club3.jpeg'
import projects11 from '../../assets/images/touse/bird.jpeg'
import projects12 from '../../assets/images/touse/clubb.jpeg'
import projects3r from '../../assets/images/touse/7.jpg'
import projects3r1 from '../../assets/images/touse/9.jpg'
import projects3r2 from '../../assets/images/touse/12-0000.jpg'
import projects3r4 from '../../assets/images/touse/14-0000.jpg'
    ...
    return (
        <div className='Gallerypage'>
                ...
                <div className='container'>
                    <div className='packery_images'>
                            ...
                            <div className='leadall col-12 '>
                                <div className='imglead'>
                                    ...
                                    <h5 data-aos="fade-right"
                                        data-aos-offset="300"
                                        data-aos-easing="ease-in-sine">LOCATION : SOLAPUR</h5>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className='row'>
                            <div className='leadall col-6 '>
                                <div className='imglead'>
                                    ...
                                    <h5 data-aos="fade-right"
                                        data-aos-offset="300"
                                        data-aos-easing="ease-in-sine">LOCATION : GREATER THANE</h5>
                                </div>
                            </div>
                            ...
                            <div className='leadall col-6 '>
                                <div className='imglead'>
                                    ...
                                    <h5 data-aos="fade-right"
                                        data-aos-offset="300"
                                        data-aos-easing="ease-in-sine">LOCATION : BHIWANDI</h5>
                                </div>
                            </div>
                        </div>
                        {/* projectimg2 */}
                        <div className='row'>
                            <div className='leadall col-6 '>
                                <div className='imglead'>
                                    <img className='imagelead_item' data-aos="fade-up-right" src={projects3r1} alt="" />
                                    <h5 data-aos="fade-right"
                                        data-aos-offset="300"
                                        data-aos-easing="ease-in-sine">LOCATION : ASONGAON</h5>
                                </div>
                            </div>

                            <div className='leadall col-6 '>
                                <div className='imglead'>
                                    <img className='imagelead_item' data-aos="fade-up-left" src={projects3r} alt="" />
                                    <h5 data-aos="fade-right"
                                        data-aos-offset="300"
                                        data-aos-easing="ease-in-sine">LOCATION : KHADAVLI</h5>
                                </div>
                            </div>
                        </div>
                        {/* projectimg2 */}
                        <div className='row'>
                            <div className='leadall col-6 '>
                                <div className='imglead'>
                                    <img className='imagelead_item' data-aos="fade-up-right" src={projects3r2} alt="" />
                                    <h5 data-aos="fade-right"
                                        data-aos-offset="300"
                                        data-aos-easing="ease-in-sine">LOCATION : KHADAVLI</h5>
                                </div>
                            ...
                            <div className='leadall col-6 '>
                                <div className='imglead'>
                                    <img className='imagelead_item' data-aos="fade-up-left" src={projects3r4} alt="" />
                                    <h5 data-aos="fade-right"
                                        data-aos-offset="300"
                                        data-aos-easing="ease-in-sine">LOCATION : KALYAN</h5>
                                </div>
                            </div>
                        </div>
                        {/* projectimg3  */}
            ...
            <div className='gallery_contact'>
                <div className='container contact_box' data-aos="zoom-out-right">
